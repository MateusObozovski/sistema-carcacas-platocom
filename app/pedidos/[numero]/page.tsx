      ...
      <ProtectedRoute>
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground">
            O pedido {params.numero} não existe no sistema.
          </p>
              ...
              (pedido.status === "Aguardando Devolução" ||
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>
                        Confirmar devolução de carcaça
                      </AlertDialogTitle>
                      <AlertDialogDescription>
                        Tem certeza que deseja registrar a devolução da carcaça
                        do pedido {pedido.numero_pedido}? O
                        {pedido.debito_carcaca || 0} carcaça(s) será(ão)
                        devolvida(s) automaticamente.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel>Cancelar</AlertDialogCancel>
                      <AlertDialogAction onClick={handleRegistrarDevolucao}>
                        Confirmar Devolução
                      </AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
            ...
            <CardContent className="space-y-2">
              ...
              {pedido.numero_pedido_origem && (
                <div>
                  ...
                  <p className="font-medium">{pedido.numero_pedido_origem}</p>
                </div>
              )}
              {pedido.empresa && (
                <div>
